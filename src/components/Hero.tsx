          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                ...
                <a
                  href="tel:5044002460"
                  className="bg-white text-[#2E2E2E] px-8 py-4 rounded-lg hover:bg-gray-100 active:scale-95 transition-all duration-300 font-bold text-lg flex items-center justify-center gap-3 shadow-xl hover:shadow-2xl hover:scale-105"
                >
                  <Phone className="w-6 h-6 text-[#7A0F12] flex-shrink-0" />
                  <span className="flex flex-col items-start leading-tight">
                    <span className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Call or Text Now</span>
                    <span className="font-black text-[#2E2E2E] text-xl">504-400-2460</span>
                  </span>
                </a>
              </div>
